    ...
    (<Link
      ...
      <div
        ...
        <div
          ...
          className="absolute left-1/2 top-1/2  flex justify-start items-start  rounded-2xl border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden">
